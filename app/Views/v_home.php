...
<body>
    <center>
        <h1>hello world</h1>
        <img src="https://static.wikitide.net/tampvanwiki/0/0a/Rusdi_Omaygot.png" alt="">
        <br>
        <br>
        <a href="/produk" style="text-decoration: none;">produk</a>
        <a href="/keranjang" style="text-decoration: none;">keranjang</a>
    </center>
</body>
</html>
