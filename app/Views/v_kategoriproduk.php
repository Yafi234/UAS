        ...
        <?php foreach ($kategori as $index => $kat): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= base_url('kategori-produk/delete/' . $kat['id']) ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus kategori ini?')">
                        Hapus
                    </a>
                </td>
            </tr>
            ...
            <div class="modal fade" id="editModal-<?= $kat['id'] ?>" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('kategori-produk/edit/' . $kat['id']) ?>" method="post">
                            <?= csrf_field(); ?>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('kategori-produk') ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group mb-2">
                        <label for="nama_kategori">Nama Kategori</label>
